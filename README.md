# Images Data Feed Service

## General
Images data feed service provides the following functionality:
- [Images data feed web API](https://github.com/dkfz-unite/unite-images-feed/blob/main/Docs/api-images.md) - REST API for uploading images and image analysis data to the portal (including input data validation).
...
## Configuration
To configure the application, change environment variables in either docker or [launchSettings.json](https://github.com/dkfz-unite/unite-images-feed/blob/main/Unite.Images.Feed.Web/Properties/launchSettings.json) file (if running locally):
...
### Docker
[Dockerfile](https://github.com/dkfz-unite/unite-images-feed/blob/main/Dockerfile) is used to build an image of the application.
